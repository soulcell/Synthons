...
using Synthons.WinUI3.Activation;
using Synthons.WinUI3.Contracts.Services;
using Synthons.WinUI3.Core.Contracts.Services;
using Synthons.WinUI3.Core.Services;
using Synthons.WinUI3.Helpers;
using Synthons.WinUI3.Models;
using Synthons.WinUI3.Services;
using Synthons.WinUI3.ViewModels;
using Synthons.WinUI3.Views;

namespace Synthons.WinUI3;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            {
                options.UseSqlServer(context.Configuration.GetConnectionString("SynthonsConnectionString"));
            });
